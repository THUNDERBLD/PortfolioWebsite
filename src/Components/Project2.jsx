...
const Webslider = [
  {
    image: "https://miro.medium.com/v2/resize:fit:1400/0*An8Aw5Hg3T09tE_n",
    title: "Advista",
    description: "Advista, a gaming console and setup website, leverages React and its libraries to deliver an interactive and seamless user experience.",
  ...
  {
    image: "https://cdn-dynmedia-1.microsoft.com/is/image/microsoftcorp/InteractiveDemo-M365Video-832x468?resMode=sharp2&op_usm=1.5,0.65,15,0&wid=832&qlt=95&fit=constrain",
    title: "Microsoft UI Clone ",
    description: "Microsoft website UI using TailwindCSS involves utilizing Tailwind's utility-first CSS framework to design responsive, modern, and consistent web interfaces.",
    link: "https://github.com/THUNDERBLD/Microsoft-Clone"
  },
  // {
...
const Otherslider = [
  {
    ...
    description: "Spam mail detection using linear regression involves training a model to classify emails as spam or non-spam based on various features, such as the presence of certain keywords.",
    link: "https://github.com/THUNDERBLD/SpamMailDectition"
  },
  {
  ...
  {
    image: "https://static1.xdaimages.com/wordpress/wp-content/uploads/2022/05/calculatorgoogle.jpg",
    title: "Calculator",
    description: "A simple and efficient calculator for performing basic arithmetic operations with a user-friendly interface. Designed for quick calculations, it's perfect for everyday use and easy to navigate.",
    link: "https://github.com/THUNDERBLD/Calculator"
  },
];
    ...
    <>
      <div ref={bodyRefs} className="relative border-none w-screen h-screen bg-black">
        <div style={{ "height": "100vh" }} className="absolute z-20 w-full h-full hidden sm:flex justify-center">
          <img style={{ "width": "500px", "height": "100vh" }} className="object-bottom translate-y-100 scale-125 translate-y-44" src="https://raw.githubusercontent.com/THUNDERBLD/Material/main/drakKnight.png" alt="" />
        </div>
            ...
            <div className='absolute scroller w-full -translate-x-1/2 text-7xl font-semibold h-24 flex'>
              {[0, 1, 2, 3, 4, 5].map((i) => (
                <div key={i} ref={(el) => (textRefs.current[i] = el)} className='text px-10 bg-black flex flex-shrink-0 items-center'>
                  THUNDER <span className='text-blue-500'> BLOOD </span> 
